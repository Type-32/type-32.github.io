        ...
        <NConfigProvider :theme="darkTheme" class="gap-3">
            <NSpin :show="loading">
                ...
                <NInputGroup class="flex flex-row">
                    <NInput v-model:value="userInput" class="flex flex-grow text-left" placeholder="Tell me your issues..." type="textarea"/>
                    <div class="flex-grow flex-row">
                        <NButton @click="handleFormSubmit" class="flex-row h-full" strong>Ask</NButton>
                    </div>
                </NInputGroup>
